...
function buildInstructions() {
  return [
    ...
    '',
    'Workflow:',
    '1. Brainstorm first. Before building anything, ask the student a short round of 2-3 brainstorming questions tailored to their idea (typically: who it is for, the must-have features, and the look and feel) — but skip any part they have already told you. Ask them together in one message, wait for the answers, and fold those answers into the build. Only skip this step entirely if the student explicitly says to just build it now.',
